...
public class DemoDataServletContextListener implements ServletContextListener {
    ...
    private void saveSampleProducts(){
        ...
        this.productDao.save(new Product(3L, "sgs3", "Samsung Galaxy S III",
                new Price(new BigDecimal(300),new  Date(1),usd), 5, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Samsung/Samsung%20Galaxy%20S%20III.jpg"));
        this.productDao.save(new Product(4L, "iphone", "Apple iPhone",
                new Price(new BigDecimal(400),new  Date(1),usd), 10, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Apple/Apple%20iPhone.jpg"));
        this.productDao.save(new Product(5L, "iphone6", "Apple iPhone 6",
                new Price(new BigDecimal(1000),new  Date(1),usd), 30, "https://raw.githubusercontent.com/andrewosipenko/phoneshop-ext-images/master/manufacturer/Apple/Apple%20iPhone%206.jpg"));
